                ...
                <thead>
                    ...
                    <?php
                        ...
                        for($x=1; $x<21; $x++)
                        {
                            ...
                            ?>
                                <span onclick="abrirModal('<?php echo $zona; ?>','Limpieza y Sanitizado(Desmalezado, Basura, Desratizado)','CUSTOM31','<?php echo $preguntaFinal; ?>')">
                                <?php echo $cantidad; ?> </span>
                            ...
                            ?>
                                <span onclick="abrirModal('<?php echo $zona; ?>','Alarmas en Equipos (Energia, RAN y TX)','CUSTOM33', '<?php echo $preguntaFinal; ?>')">
                                 <?php echo $cantidad; ?> </span>
                            ...
                            ?>
                                <span onclick="abrirModal('<?php echo $zona; ?>','Estado GG (Alarmas, nivel de combustible)','CUSTOM35','<?php echo $preguntaFinal; ?>')">
                                <?php echo $cantidad; ?> </span>
                            ...
                            ?>
                                <span onclick="abrirModal('<?php echo $zona; ?>','Se observan conexiones Irregulares de Electricidad?','CUSTOM37','<?php echo $preguntaFinal; ?>')">
                                <?php echo $cantidad; ?> </span>
                            ...
                            ?>
                                <span onclick="abrirModal('<?php echo $zona; ?>','Se observa el uso indebido de las instalaciones físicas?','CUSTOM39','<?php echo $preguntaFinal; ?>')">
                                <?php echo $cantidad; ?> </span>
                            ...
                            ?>
                                <span onclick="abrirModal('<?php echo $zona; ?>','Se observan problemas estructurales en la torre?','CUSTOM41','<?php echo $preguntaFinal; ?>')">
                                <?php echo $cantidad; ?> </span>
                         ...
                         /*      foreach ($arrayDevuelto as $arreglito)
                             {
                               foreach( $arreglito as $pregunta){
                            ...
                            /*  foreach ($arrayDevuelto as $columna)
                             {
                                  ...
                                  $cantidad += $columna[$cont]["CANTIDAD"];
                                 $cont++;
                             }
                             echo $cantidad; */
                             $cont = 0;
                              ...
                              $preguntaFinal = $arrayDevuelto['PreguntasFinal'];
                               ...
                               //echo $cantidad;
                            ?>
                             <span onclick="abrirDetalle('<?php echo $zona ; ?>','<?php echo $cantidad ; ?>')"><?php echo $cantidad; ?> </span>
                            </td>
                        </tr>
                        ...
                        if($zona == "Z08O")
                        {
                            ...
                            ?>
                        <span onclick="abrirModal('<?php echo $zona; ?>','Se observa el uso indebido de las instalaciones fisicas?','CUSTOM39','<?php echo $preguntaFinal; ?>')">
                        <?php echo $cantidad; ?> </span>
            ...
            <div class="modal-body" id="contenedor_estado">
              ...
              <form class="row" id="formEdit">
                    ...
                    <div class="col-xs-6 sinpadding">
                        ...
                        <div class="col-xs-6 sinpadding">
                            <label class="col-xs-4">Problemas:</label>
                            <div class="input-group col-xs-8">
                                <input style="text-transform: uppercase"  type="text" name="proble" id="proble" class="form-control" readonly />
                                <input type="hidden" name="proble" id="proble" class="form-control"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-xs-12">
...
<div class="modal-dialog modal-lg"style="width:1250px;">
    ...
    <script>
      ...
      function abrirModal(zona,pregunta,custom, preguntaFinal) {
